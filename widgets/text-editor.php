...
class Widget_Text_Editor extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Text Editor', 'admire-widgets' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_editor',
			[
				'label' => esc_html__( 'Text Editor', 'admire-widgets' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '<p>' . esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'admire-widgets' ) . '</p>',
			]
		);

		$this->add_control(
			'drop_cap', [
				'label' => esc_html__( 'Drop Cap', 'admire-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'admire-widgets' ),
				'label_on' => esc_html__( 'On', 'admire-widgets' ),
		...
		$text_columns[''] = esc_html__( 'Default', 'admire-widgets' );

		$this->add_responsive_control(
			'text_columns',
			[
				'label' => esc_html__( 'Columns', 'admire-widgets' ),
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => esc_html__( 'Columns Gap', 'admire-widgets' ),
		...
		$this->add_responsive_control(
			'align',
			[
				'label' => esc_html__( 'Alignment', 'admire-widgets' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'admire-widgets' ),
						'icon' => 'eicon-text-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'admire-widgets' ),
						'icon' => 'eicon-text-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'admire-widgets' ),
						'icon' => 'eicon-text-align-right',
					],
					'justify' => [
						'title' => esc_html__( 'Justified', 'admire-widgets' ),
		...
		$this->add_control(
			'text_color',
			[
				'label' => esc_html__( 'Text Color', 'admire-widgets' ),
		...
		$this->add_control(
			'drop_cap_view',
			[
				'label' => esc_html__( 'View', 'admire-widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Default', 'admire-widgets' ),
					'stacked' => esc_html__( 'Stacked', 'admire-widgets' ),
					'framed' => esc_html__( 'Framed', 'admire-widgets' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Primary Color', 'admire-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Secondary Color', 'admire-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'drop_cap_size',
			[
				'label' => esc_html__( 'Size', 'admire-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->add_control(
			'drop_cap_space',
			[
				'label' => esc_html__( 'Space', 'admire-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 10,
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Radius', 'admire-widgets' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_control(
			'drop_cap_border_width', [
				'label' => esc_html__( 'Border Width', 'admire-widgets' ),
	...
	protected function render() {
		...
		if ( $should_render_inline_editing ) {
			$this->add_render_attribute( 'editor', 'class', [ 'elementor-text-editor', 'elementor-clearfix', 'content-width-inner' ] );
		}
	...
	protected function content_template() {
		...
		if ( shouldRenderInlineEditing ) {
			view.addRenderAttribute( 'editor', 'class', [ 'elementor-text-editor', 'elementor-clearfix', 'content-width-inner' ] );
		}
